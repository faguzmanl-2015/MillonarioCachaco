...
public class Profile {
     ...
     *
     */
    public Profile (String userId, String displayName, String mainEmail, RolUsuario teeShirtSize) {
        this.userId = userId;
        this.displayName = displayName;
        this.mainEmail = mainEmail;
        this.rolUser = teeShirtSize;
    }
     ...
     * @param rolUser
     */
    public void update(String displayName, RolUsuario teeShirtSize) {
        if (displayName != null) {
            this.displayName = displayName;
        }
