package co.edu.unal.loteria.domain;
...
public class ResultadoLoteria {
     ...
     *
     * We use automatic id assignment for entities of ResultadoLoteria class.
     */
    @Id
    private long id;

    /**
     * The name of the ResultadoLoteria.
     */
    @Index
    private String name;

    /**
     * The description of the ResultadoLoteria.
     */
    ...
    /**
     * Topics related to this ResultadoLoteria.
     */
    @Index
    ...
    /**
     * The name of the city that the ResultadoLoteria takes place.
     */
    @Index(IfNotDefault.class) private String city;

    /**
     * The starting date of this ResultadoLoteria.
     */
    private Date oneDa;

    /**
     * The ending date of this ResultadoLoteria.
     */
    ...
    /**
     * The maximum capacity of this ResultadoLoteria.
     */
    @Index
    ...
    public ResultadoLoteria(final long id, final String organizerUserId,
                      final ResultadoForm conferenceForm) {
    ...
    public String getWebsafeKey() {
        return Key.create(profileKey, ResultadoLoteria.class, id).getString();
    }
    ...
    public Date getStartDate() {
        return oneDa == null ? null : new Date(oneDa.getTime());
    }
    ...
    /**
     * Updates the ResultadoLoteria with ResultadoForm.
     * This method is used upon object creation as well as updating existing ResultadoLoteria.
     *
     * 
     */
    @SuppressWarnings("static-access")
	public void updateWithConferenceForm(ResultadoForm conferenceForm) {
        this.name = conferenceForm.getName();
        this.creacion = this.name;
        this.resultado = conferenceForm.getDescription();
        ...
        Date fecha = conferenceForm.getStartDate();
        this.oneDa = fecha == null ? null : new Date(fecha.getTime());
    ...
    public String toString() {
        ...
        if (oneDa != null) {
            stringBuilder.append("Fecha: ").append(oneDa.toString()).append("\n");
        }
        if (endDate != null) {
