...
/**
 * A simple Java object (POJO) representing a query options for Resultado.
 */
public class ResultadoQueryForm {

    private static final Logger LOG = Logger.getLogger(ResultadoQueryForm.class.getName());
     ...
     */
    public ResultadoQueryForm filter(Filter filter) {
        if (filter.operator.isInequalityFilter()) {
     ...
     */
    @ApiResourceProperty(ignored = AnnotationBoolean.TRUE)
    public Query<ResultadoLoteria> getQuery() {
