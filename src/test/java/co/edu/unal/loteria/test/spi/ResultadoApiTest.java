...
public class ResultadoApiTest {
    ...
    private static final RolUsuario TEE_SHIRT_SIZE = RolUsuario.NOT_SPECIFIED;
    ...
    public void testUpdateProfile() throws Exception {
        ...
        RolUsuario newTeeShirtSize = RolUsuario.Cliente;
    ...
    public void testCreateConference() throws Exception {
        ...
        topics.add("Cloud");
        topics.add("Platform");
        ResultadoForm conferenceForm = new ResultadoForm(
                NAME, DESCRIPTION, topics, CITY, startDate, endDate, CAP);
        ResultadoLoteria conference = conferenceApi.createConference(user, conferenceForm);
    ...
    public void testGetConferencesCreated() throws Exception {
        ...
        List<ResultadoLoteria> conferencesCreated = conferenceApi.getConferencesCreated(user);
